          ...
          <div className="absolute z-40">
            <div className="text-left mb-8">
              ...
              <h2 className="text-white text-sm font-normal w-1/2 mt-6">
                We&apos;re a software development agency that provides a range of services including maintenance, documented APIs, React and Next.js frontends, and deployment offerings.</h2>
            </div>
          </div>
        </div>
      </div>
