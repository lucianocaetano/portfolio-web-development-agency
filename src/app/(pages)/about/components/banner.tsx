  ...
  return (
    <div className="@container pb-4">
      <div
        ...
        style={{ backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.1) 0%, rgba(0, 0, 0, 0.4) 100%), url("/banner about.webp")' }}
      >
        ...
        <div className="absolute z-50">
          <div className="text-left mb-8">
            ...
            <h1
              className="text-background text-4xl font-black leading-tight tracking-[-0.033em] @[480px]:text-5xl @[480px]:font-black @[480px]:leading-tight @[480px]:tracking-[-0.033em]"
            > Percy Pocket Solutions </h1>
            <h2 className="text-background text-sm font-normal w-1/2 mt-6">
